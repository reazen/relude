...
var Failure = /* @__PURE__ */Caml_exceptions.create("Stdlib.Stream.Failure");

var $$Error = /* @__PURE__ */Caml_exceptions.create("Stdlib.Stream.Error");
...
function fill_buff(b) {
  b.len = Stdlib.input(b.ic, b.buff, 0, b.buff.length);
  b.ind = 0;
}
...
function of_list(l) {
  return {
          count: 0,
          data: Stdlib__List.fold_right((function (x, l) {
                  return {
                          TAG: /* Scons */0,
                          _0: x,
                          _1: l
...
function dump_data(f, param) {
  if (typeof param === "number") {
    return Stdlib.print_string("Sempty");
  }
  switch (param.TAG | 0) {
    case /* Scons */0 :
        Stdlib.print_string("Scons (");
        Curry._1(f, param._0);
        Stdlib.print_string(", ");
        dump_data(f, param._1);
        return Stdlib.print_string(")");
    case /* Sapp */1 :
        Stdlib.print_string("Sapp (");
        dump_data(f, param._0);
        Stdlib.print_string(", ");
        dump_data(f, param._1);
        return Stdlib.print_string(")");
    case /* Slazy */2 :
        return Stdlib.print_string("Slazy");
    case /* Sgen */3 :
        return Stdlib.print_string("Sgen");
    case /* Sbuffio */4 :
        return Stdlib.print_string("Sbuffio");
    
  }
}

function dump(f, s) {
  Stdlib.print_string("{count = ");
  Stdlib.print_int(count(s));
  Stdlib.print_string("; data = ");
  dump_data(f, data(s));
  Stdlib.print_string("}");
