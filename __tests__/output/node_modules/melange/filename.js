...
function quote_cmd_filename(f) {
  if (!(Stdlib__String.contains(f, /* '"' */34) || Stdlib__String.contains(f, /* '%' */37))) {
...
function temp_file_name(temp_dir, prefix, suffix) {
  var rnd = Stdlib__Random.State.bits(CamlinternalLazy.force(prng)) & 16777215;
...
exports.chop_suffix_opt = chop_suffix_opt$2;
...
exports.quote_command = quote_command$2;
