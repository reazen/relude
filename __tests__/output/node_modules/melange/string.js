...
function copy(s) {
  return Caml_bytes.bytes_to_string(Stdlib__Bytes.copy(Caml_bytes.bytes_of_string(s)));
}
  ...
  while(true) {
    ...
    if (match > 91 || match < 32) {
      if (match > 126 || match < 93) {
        return Caml_bytes.bytes_to_string(Stdlib__Bytes.escaped(Caml_bytes.bytes_of_string(s)));
      }
      _i = i + 1 | 0;
      continue ;
    }
...
function uppercase(s) {
  return Caml_bytes.bytes_to_string(Stdlib__Bytes.uppercase(Caml_bytes.bytes_of_string(s)));
}

function lowercase(s) {
  return Caml_bytes.bytes_to_string(Stdlib__Bytes.lowercase(Caml_bytes.bytes_of_string(s)));
}
...
function uncapitalize(s) {
  return Caml_bytes.bytes_to_string(Stdlib__Bytes.uncapitalize(Caml_bytes.bytes_of_string(s)));
}
