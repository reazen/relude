...
function set(t, newK, newD) {
  ...
  var k = n.k;
  if (newK === k) {
    return Belt_internalAVLtree.updateValue(n, newD);
  }
  var v = n.v;
  if (newK < k) {
    return Belt_internalAVLtree.bal(set(n.l, newK, newD), k, v, n.r);
  } else {
    return Belt_internalAVLtree.bal(n.l, k, v, set(n.r, newK, newD));
  }
}
...
function updateU(t, x, f) {
  if (t !== undefined) {
    ...
    if (x === k) {
      ...
      if (data !== undefined) {
        return Belt_internalAVLtree.updateValue(n, Caml_option.valFromOption(data));
      }
      var l = n.l;
      var r = n.r;
      if (l === undefined) {
