      ...
      module Traversable: {
        ...
        module Fold_Map_Plus:
          (P: BsAbstract.Interface.PLUS) =>
           {let fold_map: ('a => P.t('a), t('a)) => P.t('a);};
        type applicative_t('a) =
          Relude_Validation.WithErrors(Relude_Array_Instances.SemigroupAny)(Error).Applicative.t(
            'a,
          );
        let traverse:
          ('a => applicative_t('b), t('a)) => applicative_t(t('b));
  ...
  module WithErrorsAsArrayOfStrings: {
    module Traversable: {
      ...
      type applicative_t('a) =
        Relude_Validation.t(
          'a,
          Relude_Array_Instances.SemigroupAny.t(string),
        );
      let traverse:
        ('a => applicative_t('b), t('a)) => applicative_t(t('b));
      let sequence: t(applicative_t('a)) => applicative_t(t('a));
      ...
      module Traversable: {
        ...
        module Fold_Map_Plus:
          (P: BsAbstract.Interface.PLUS) =>
           {let fold_map: ('a => P.t('a), t('a)) => P.t('a);};
        type applicative_t('a) =
          Relude_Validation.WithErrors(Relude_NonEmpty.Array.SemigroupAny)(Error).Applicative.t(
            'a,
          );
        let traverse:
          ('a => applicative_t('b), t('a)) => applicative_t(t('b));
