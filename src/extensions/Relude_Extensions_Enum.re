...
module EnumExtensions = (E: Relude_Interface.ENUM) => {
  // These would be better implemented in terms of Unfoldable rather than list, but I'll just use list for simplicity.
  // We can change/add this when needed/requested.

  /**
   * Generates a list of values of the Enum between the given start and finish values (inclusive)
   */
  ...
  /**
   * Generates a list of enum values that come after the given start value (not including the start)
   * Warning: the resulting list could be unbounded here
   */
  ...
  /**
   * Generates a list of enum values that come after the given start value (including the start)
   * Warning: the resulting list could be unbounded here
   */
  ...
  /**
   * Generates a list of enum values that come before the given start value (not including the start)
   * Warning: the resulting list could be unbounded here
   */
  ...
  /**
   * Generates a list of enum values that come before the given start value (including the start)
   * Warning: the resulting list could be unbounded here
   */
